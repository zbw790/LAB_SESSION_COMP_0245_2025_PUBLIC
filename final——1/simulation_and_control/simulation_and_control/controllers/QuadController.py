from mpc_quad_srbd.SrbdControllerInterface import SRBDControllerInterface
from mpc_quad_wb.WbQuadInterface import WBInterface
...
class QuadrupedCtrl:
    ...
    def __init__(self, 
        ...
        """ Constructor of the QuadrupedCtrl class.

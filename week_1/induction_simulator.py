...
def main():
    ...
    while True:
        tau_cmd = np.zeros((dyn_model.getNumberofActuatedJoints(),)) # Zero torque command
        cmd.SetControlCmd(tau_cmd, ["torque"]*dyn_model.getNumberofActuatedJoints())  # Set the torque command
        sim.Step(cmd, "torque")
